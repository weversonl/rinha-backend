...
class PersonControllerAdviceTest {
    ...
    @Test
    void testHandleTechnicalExceptionWhenThrownThenReturnsCorrectResponseEntity() {

        String exceptionMessage = "Technical error occurred";
        ...
        assertEquals(Constants.INTERNAL_SERVER_EX, responseEntity.getBody().getMessage());
        assertEquals(exceptionMessage, responseEntity.getBody().getDescription());
    }
